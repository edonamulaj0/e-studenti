...
export default function FshmnDetail() {
  const faculty = {
    name: "Fakulteti i Matematikës dhe Shkencave të Natyrës",
    code: "FSHMN",
    description:
      "Fakulteti i Matematikës dhe Shkencave Natyrore siguron arsim dhe hulumtim në matematikë, fizikë, kimi, biologji dhe disiplina shkencore të lidhura.",
    established: "XXXX",
